...
function defaultRot(map,active){
	...
	if(active){
		for(c = 0; c < this.nCoord; c++){
			...
			if(map.isBlocked(rotVect.pos(map))){
				return;
			}
		}
	}
...
},{"./TetrisPiece":4,"./Vector":6}],4:[function(require,module,exports){
...
},{"./Environment":2,"./Utils":5,"./Vector":6}],5:[function(require,module,exports){
/* jshint esversion:6 */

exports.hello = "hello";

exports.max = function max(i, j){
	return (i > j) ? i : j;
};
...
},{"./tetris":8,"jquery":1}],8:[function(require,module,exports){
var environment = require('./Environment');
var vector = require('./Vector');
var tetrisPiece = require('./TetrisPiece');
...
TetrisGame.prototype.init_table = function init_table(){
	...
	var _resize = function _resize(){
		var gridDim = min( 0.8*parseInt(sideGrid.css('width')), 250);
		preview.css({
			height:gridDim+"px",
			width:gridDim+"px"
		});
		if(this.nextPiece) this.fixPrev();
	}.bind(this);
...
TetrisGame.prototype.fixPrev = function fixPrev(){
	...
	// place the next piece in the play area.
	var np = this.nextPiece;
	np.startPos(this.next);
